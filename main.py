...
origins = [
    ...
    "https://parcialfinal-ac38b.web.app/",  # Agrega aquí el dominio de tu aplicación en producción
]
...
listaTipeCancer = np.array(['Kidney cancer', 'Larynx cancer', 'Thyroid cancer',
       'Uterine cancer', 'Ovarian cancer', 'Pancreatic cancer',
       ...
       'Multiple myeloma', 'Breast cancer', 'Bladder cancer',
       'Cervical cancer', 'Esophageal cancer', 'Leukemia',
       'Hodgkin lymphoma', 'Liver cancer', 'Stomach cancer',
       'Prostate cancer', 'Colon and rectum cancer',
...
async def root():
    ...
    resultados['Tipo de Cancer'] = listaTipeCancer[resultados.index ]
